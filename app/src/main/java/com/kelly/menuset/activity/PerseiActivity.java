...
import com.kelly.menuset.BaseActivity;
import com.kelly.menuset.R;

public class PerseiActivity extends BaseActivity {
    private PerseiLayout perseiLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_persei);
        initPerseiView();
        initbar();
    }
    ...
    public class IconAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_persei_top_menu, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.mImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(PerseiActivity.this, "you have select pos--->" + position, Toast.LENGTH_SHORT).show();
                    Toast.makeText(PerseiActivity.this, "Pretend to see beautiful special effects" , Toast.LENGTH_LONG).show();
